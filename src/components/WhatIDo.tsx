        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                I build end-to-end web applications using modern frameworks and
                tools — from responsive frontends to robust backend APIs with
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                I design and develop AI-powered applications — from chatbots
                with natural language processing to machine learning models for
